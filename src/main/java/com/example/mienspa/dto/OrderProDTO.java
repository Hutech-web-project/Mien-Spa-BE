...
public class OrderProDTO extends AbstractDTO<OrderProDTO>{
	...
	private Collection<ProductDetailsDTO> listPro;
	...
	public Collection<ProductDetailsDTO> getListProId() {
		return listPro;
	}

	public void setListProId(Collection<ProductDetailsDTO> listProId) {
