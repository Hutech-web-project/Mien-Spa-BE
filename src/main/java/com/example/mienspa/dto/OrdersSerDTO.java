...
public class OrdersSerDTO extends AbstractDTO<OrdersSerDTO>{
	...
	private List<ServiceDetailsDTO> listSer;
	...
	public OrdersSerDTO(String orSerId, String orSerUserId, String orSerPhoneNo, String orSerStatus,
			String orSerStartTime, String orSerEndTime, Integer orSer_Total, List<ServiceDetailsDTO> listSer) {
		super();
	...
	public List<ServiceDetailsDTO> getlistSer() {
		return listSer;
	}

	public void setlistSer(List<ServiceDetailsDTO> listSer) {
		this.listSer = listSer;
	}
}
